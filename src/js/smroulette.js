document.addEventListener("DOMContentLoaded", function() {
    ...
    function(t) {
        const e = { l: "l", an: "an", discText: ["скидка 50%", "скидка 40%", "скидка 20%", "скидка 18%"], di: "di", ng: "ng", sectionText: { respondText: "Наш менеджер свяжется с вами, чтобы принять заказ и сообщит подробнее о выигрыше.", placeholderText: "Введите номер", phoneMask: "+7(000)000-00-00", agreement: { isRequired: !1, isLink: !1 } }, cookiesLife: 1, a: "a", r: "r", res: '<p>Скрипт не будет работать, если убрать ссылку на разработчика. Чтобы использовать виджет без этой ссылки, приобретите полную версию <a href="https://smartlanding.biz/smartroulette-lp/">тут!</a></p>' },
            a = {
                createTextArea() {
                    const { respondText: r, placeholderText: n, phoneMask: s, agreement: o } = e.sectionText, i = t("<div>").attr({ class: "smart-roulette__right-block" }), l = t("<div>").attr({ class: "smart-roulette__text-area" }), c = t("<div>").attr({ class: "smart-roulette__text-respond" }).html(`\n                <div class="smart-roulette__title-respond">Ваш выигрыш:</div>\n                <div class="smart-roulette__prize-respond"></div>\n                <div class="smart-roulette__subtitle-respond">${r}</div>\n                `), u = t("<div>").attr({ class: "smart-roulette__text-title" }).text("Испытайте удачу!"), p = t("<div>").attr({ class: "smart-roulette__text-description" }).text("Введите номер телефона, вращайте колесо и получите приз при совершении заказа!"), d = t("<form>").attr({ class: "smart-roulette__form", id: "smart-roulette__form", enctype: "multipart/form-data" }), m = t("<div>").attr({ class: "smart-roulette__input-wrapper" }), f = t("<div>").attr({ class: "smart-roulette__input-msgs smart-roulette__input-msgs_error" });
                    ...
                    h.blur(function() { t(this).val().length === s.length ? (f.text(""), v.input = !0, g()) : t(this).val().length >= 1 && (v.input = !1, g(), f.text("Убедитесь в правильности номера телефона")) }), h.keyup(function() { t(this).val().length !== s.length && 0 !== t(this).val().length || f.text("") }), m.append(h).append(f);
                    const k = t("<input>").attr({ type: "hidden", name: "section[]", value: e.discText }),
                        _ = t("<button>").attr({ class: "smart-roulette__button" }).html('<div class="smart-roulette__button-inner">Вращать</div>'),
                    ...
                    if (d.append(u).append(p).append(b).append(k), o.isRequired) {
                        ...
                        let a = t("<label>").attr({ class: "smart-roulette__label-agreement", for: "smart-roulette__input-agreement" }),
                            r = t("<input>").attr({ type: "checkbox", name: "agreement", class: "smart-roulette__input-agreement", id: "smart-roulette__input-agreement", checked: !0, value: "Я принимаю пользовательское соглашение" }),
                            n = t("<div>").attr({ class: "smart-roulette__input-msgs" }),
                            s = null;
                        s = o.isLink ? t("<a>").attr({ class: "smart-roulette__link-agreement", href: o.isLink, target: "_blank", rel: "nofollow" }) : t("<span>").attr({ class: "smart-roulette__link-agreement" }), r.is(":checked") ? s.text("Я принимаю пользовательске соглашение") : s.text("Я не принимаю пользовательское соглашение"), a.click(function() { r.is(":checked") ? (s.text("Я не принимаю пользовательске соглашение"), r.val("Я не принимаю пользовательске соглашение"), v.checkbox = !1, g(), n.text("Примите соглашение")) : (s.text("Я принимаю пользовательское соглашение"), r.val("Я принимаю пользовательское соглашение"), v.checkbox = !0, g(), n.text("")) }), e.append(r).append(a).append(s).append(n), d.append(e)
                    }
                ...
                init: function(r) { t.extend(e, r); const n = t("<button>").attr({ class: "smart-roulette__gift smart-roulette__gift_left" }); return n.append('<img src="img/gift.svg"  width="80" alt="Подарок" title="Забeрите свой подарок!">'), this.each(function() { t(this).append(n), t(this).append(a.createWidget()) }) }
            };
